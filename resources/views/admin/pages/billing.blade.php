              ...
              <table class="table align-items-center justify-content-center mb-0">
                <thead>
                  <tr> 
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Date Create</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <p class="text-sm font-weight-bold mb-0">{{ $item->MAKHACHHANG }}</p>
                    </td>
                    <td>
                      <p class="text-sm font-weight-bold mb-0">{{ $item->SDT }}</p>
                    </td>
                    <td>
                      <p class="text-sm font-weight-bold mb-0">{{ $item->DIACHI }}</p>
                    </td>
                    <td>
                      <p class="text-sm font-weight-bold mb-0">{{ $item->GHICHU }}</p>
                    </td>
                    <td>
                      <p class="text-sm font-weight-bold mb-0">{{ $item->NGAYLAP }}</p>
                    </td>
                    <td>
                      <p class="text-sm font-weight-bold mb-0">{{ $item->NGAYGIAO }}</p>
                    </td>
                    <td>
                      <p class="text-sm font-weight-bold mb-0">{{ $item->TONGTIEN }}</p>
                    </td>
                    <td>
                      <p class="text-sm font-weight-bold mb-0">{{ $item->TRANGTHAI }}</p>
                    </td>
                    <td class="col-lg-2 mb-lg-0 mb-4">
                      <a href="{{ route('billcreate') }}">Create</a>
                      &nbsp
                      <a href="{{ route('billing.edit',$item->id) }}">Edit</a> 
                      &nbsp
                      <a href="{{ route('billing.detail',$item->id) }}">Details</a> 
                      &nbsp
                      <a href="{{ route('billing.delete',$item->id) }}">Delete</a>
                    </td>
                  </tr>
                </tbody>
                @endforeach
