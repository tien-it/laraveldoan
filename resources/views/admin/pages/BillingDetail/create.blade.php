                ...
                <div class="row container ">
                    ...
                    <div class="col-md-5">
                        <form action="{{ route('billing.create') }}" method="POST">
                            ...
                            <div class="form-group">
                                <input class="form-control" type="text" id = "DONGIA" name="DONGIA"  placeholder="Price">
                            </div>
                            <div class="form-group">
                                <input class="form-control" type="text" id ="THANHTIEN" name="THANHTIEN"  placeholder="Total" >
                            </div>
                            <div class="form-group">
